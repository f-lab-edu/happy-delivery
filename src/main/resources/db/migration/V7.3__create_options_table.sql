...
(
    ...
    price           int         not null,
    primary key (id, restaurant_id, menu_group_id, menu_id, option_group_id),
    constraint option_groups__options__option_group_id_fk foreign key (option_group_id) references option_groups (id) on update cascade on delete cascade,
